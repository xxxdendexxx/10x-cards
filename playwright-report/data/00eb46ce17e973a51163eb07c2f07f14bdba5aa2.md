...
- Name: Login form validation >> shows validation error when fields are empty
- Location: C:\Users\pmwaba\source\repos\10x-cards\tests\login.spec.ts:26:3
...
Expected string: "Both email and password are required."
Received string: ""
Call log:
  ...
  - waiting for getByTestId('login-error-message')
    ...
    at C:\Users\pmwaba\source\repos\10x-cards\tests\login.spec.ts:31:5
```
