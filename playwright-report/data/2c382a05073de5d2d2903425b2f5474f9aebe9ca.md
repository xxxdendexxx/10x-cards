...
- Name: Login form validation >> shows validation error for invalid email format
- Location: C:\Users\pmwaba\source\repos\10x-cards\tests\login.spec.ts:13:3
...
Expected string: "Please enter a valid email address."
Received string: ""
Call log:
  ...
  - waiting for getByTestId('login-error-message')
    ...
    at C:\Users\pmwaba\source\repos\10x-cards\tests\login.spec.ts:23:5
```
...
- text: Password
- textbox "Password": rQl6kiuCdjr2rtp
- paragraph
- button "Sign in"
